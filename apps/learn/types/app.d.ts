...
declare global {
   ...
   */
  declare type AppStore = import('../core/app/appStore').AppStore;
  declare type RootState = import('../core/app/appStore').RootState;
  declare type AppDispatch = import('../core/app/appStore').AppDispatch;
}
